...
>
### 考点分析
- 今天的题目是考察并发编程的常见基础题，给出的典型回答算是一个相对全面的总结。
>
...
>
### 知识扩展
- 专栏前面几期穿插了一些并发的概念，有同学反馈理解起来有点困难，尤其对一些并发相关概念比较陌生，所以在这一讲，也对会一些基础的概念进行补充。
>
- 首先，我们需要理解什么是线程安全。
>
...
>
- 2 不可变：还记得我们在专栏[第 3 讲](https://github.com/lu666666/notebooks/blob/master/java/0/1/03.md)强调的 final 和 immutable 吗，就是这个道理，Java 语言目前还没有真正意义上的原生不可变，但是未来也许会引入。
>
#### 线程安全需要保证几个基本特性：
...
56: monitorexit
```
- 会在下一讲，对 synchronized 和其他锁实现的更多底层细节进行深入分析。
>
...
>
#### 今天，作为专栏进入并发阶段的第一讲，介绍了什么是线程安全，对比和分析了 synchronized 和 ReentrantLock，并针对条件变量等方面结合案例代码进行了介绍。下一讲，将对锁的进阶内容进行源码和案例分析。
>
### 思考题
